...
public class LoginInterceptor {
    ...
    @Pointcut("within(com.fc.async.controller.AsyncController)")
    ...
    private boolean login(String authorization) {
        HttpRequest httpRequest = HttpUtil.createPost("获取token URL");
